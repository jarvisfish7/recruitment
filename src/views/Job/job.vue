    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-card class="job-card" shadow="always">
          ...
          <div v-else v-for="j in showJobBox" :key="j.id" @click="jobJum(j.jobId,j.companyid)">
            <div class="j-card">
              ...
              <div class="j-three">
                ...
                <p class="j-s">
                  <span class="j-time">发布于：{{ j.createTime }}</span>
                </p>
              </div>
              <!-- </router-link> -->
            </div>
      ...
      .then(res => {
        if (res.status === 200) {
          if (res.data.data.total === 0) {
            ...
            this.jobBox = res.data.data.records
